...
class CompletScreen extends StatefulWidget {
  const CompletScreen({super.key});

  @override
  State<CompletScreen> createState() => _CompletScreenState();
}

class _CompletScreenState extends State<CompletScreen> {
